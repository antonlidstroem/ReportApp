...
:root{--accent:#8b5cf6;--surface:#080616;--surface-2:#0f0926;--border:rgba(139,92,246,0.15);--text:#e2e8f0;--text-muted:#64748b}
.page{font-family:'Sora',sans-serif;max-width:1300px;margin:0 auto;color:#e2e8f0}
.hero{position:relative;overflow:hidden;border-radius:20px;background:#080616;margin-bottom:48px;display:grid;grid-template-columns:1fr 340px;min-height:420px}
.hero-glow{position:absolute;inset:0;background:radial-gradient(ellipse at 20% 50%,rgba(139,92,246,.1) 0%,transparent 60%),radial-gradient(ellipse at 80% 50%,rgba(20,184,166,.08) 0%,transparent 60%);pointer-events:none}
...
.eyebrow{font-size:11px;text-transform:uppercase;letter-spacing:2px;color:#8b5cf6;margin-bottom:12px}
.eyebrow-sm{font-size:10px;text-transform:uppercase;letter-spacing:3px;color:#8b5cf6;margin-bottom:6px;font-family:'Fira Code',monospace}
h1{font-size:44px;font-weight:800;margin:0 0 4px;color:#fff;letter-spacing:-2px}
.plus{color:#8b5cf6;margin:0 8px}
.tagline{font-family:'Fira Code',monospace;font-size:13px;color:#7c3aed;margin-bottom:16px}
...
.hero-split{position:relative;z-index:1;display:flex;flex-direction:column;border-left:1px solid rgba(255,255,255,.05)}
.hs-half{flex:1;padding:28px 20px;display:flex;flex-direction:column;gap:8px}
.hs-half.hs-purple{background:rgba(139,92,246,.04);border-bottom:1px solid rgba(255,255,255,.04)}
.hs-half.hs-teal{background:rgba(20,184,166,.04)}
.hs-half p{font-size:11px;color:#475569;line-height:1.5}
.hs-engine{font-size:15px;font-weight:700;color:#fff}
.hs-fmts{display:flex;gap:6px}
.hs-fmt{font-size:11px;padding:3px 10px;border-radius:5px;background:rgba(255,255,255,.05);color:#94a3b8;border:1px solid rgba(255,255,255,.08)}
.hs-half.hs-purple .hs-fmt{color:#a855f7;border-color:rgba(168,85,247,.3);background:rgba(168,85,247,.06)}
.hs-half.hs-teal .hs-fmt{color:#14b8a6;border-color:rgba(20,184,166,.3);background:rgba(20,184,166,.06)}
.hs-plus{text-align:center;padding:10px;font-size:18px;font-weight:800;color:rgba(255,255,255,.15);background:rgba(255,255,255,.02);border-top:1px solid rgba(255,255,255,.03);border-bottom:1px solid rgba(255,255,255,.03)}
...
.engine-compare{display:grid;grid-template-columns:1fr auto 1fr;gap:20px;align-items:start}
.ec-col{background:#080616;border-radius:12px;padding:24px}
.ec-col.ec-purple{border-top:3px solid #a855f7}
.ec-col.ec-teal{border-top:3px solid #14b8a6}
.ec-hdr{display:flex;align-items:center;gap:10px;margin-bottom:16px;font-size:13px;font-weight:700;color:#fff}
.ec-feat{display:flex;align-items:flex-start;gap:8px;padding:7px 0;border-bottom:1px solid rgba(255,255,255,.04);font-size:12px;color:#94a3b8}
.ec-feat:last-child{border-bottom:none}
.ec-check{color:#a855f7;font-weight:700;flex-shrink:0}
.ec-check.teal{color:#14b8a6}
.ec-vs{display:flex;align-items:center;font-size:18px;font-weight:800;color:rgba(255,255,255,.15);padding:0 8px;margin-top:50px}
.dual-config{display:grid;grid-template-columns:1fr auto 1fr;gap:20px;align-items:start}
.dc-half{background:#080616;border-radius:12px;padding:24px}
.dc-half.dc-purple{border-top:3px solid #a855f7}
.dc-half.dc-teal{border-top:3px solid #14b8a6}
.dc-engine-lbl{display:flex;align-items:center;gap:8px;font-size:11px;font-weight:700;color:#94a3b8;text-transform:uppercase;letter-spacing:.5px;margin-bottom:14px}
.dot{width:8px;height:8px;border-radius:50%;flex-shrink:0}
.dot.purple{background:#a855f7;box-shadow:0 0 8px #a855f7}
.dot.teal{background:#14b8a6;box-shadow:0 0 8px #14b8a6}
.dc-opts{display:flex;flex-direction:column;gap:8px;margin-bottom:14px}
.dc-opt{display:flex;align-items:flex-start;gap:10px;cursor:pointer;padding:8px;border-radius:8px;border:1px solid rgba(255,255,255,.04);transition:background .1s}
.dc-opt:hover{background:rgba(255,255,255,.02)}
.dc-opt input{margin-top:2px;accent-color:#8b5cf6;flex-shrink:0}
.dot-title{display:block;font-size:12px;font-weight:600;color:#e2e8f0;margin-bottom:1px}
.dot-desc{font-size:11px;color:#475569}
.dc-code-label{font-size:10px;color:#374151;text-transform:uppercase;letter-spacing:1px;margin-bottom:6px}
.dc-code{margin:0;padding:12px;background:#020a14;border-radius:8px;overflow-x:auto;border:1px solid rgba(255,255,255,.04)}
.dc-code code{font-family:'Fira Code',monospace;font-size:10px;color:#94a3b8;white-space:pre;line-height:1.6}
.dc-divider{display:flex;flex-direction:column;align-items:center;gap:8px;padding:20px 0;margin-top:40px}
.dc-divider div{width:2px;flex:1;background:rgba(255,255,255,.05)}
.dc-divider span{writing-mode:vertical-rl;font-size:9px;color:#374151;text-transform:uppercase;letter-spacing:1px;white-space:nowrap}
.cx-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:12px}
.cx-card{background:#080616;border-radius:10px;padding:18px;border:1px solid rgba(255,255,255,.05)}
.cx-card.cx-warn{border-top:3px solid #f59e0b}
.cx-card.cx-ok{border-top:3px solid #22c55e}
.cx-card.cx-bad{border-top:3px solid #ef4444}
.cx-sev{font-size:10px;font-weight:700;margin-bottom:6px}
.cx-card.cx-warn .cx-sev{color:#f59e0b}
.cx-card.cx-ok .cx-sev{color:#22c55e}
.cx-card.cx-bad .cx-sev{color:#ef4444}
.cx-t{font-size:13px;font-weight:700;color:#e2e8f0;margin-bottom:6px}
.cx-d{font-size:11px;color:#64748b;line-height:1.5}
